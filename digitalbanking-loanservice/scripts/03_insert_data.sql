...
insert into customer ("customer_id", "customer_name", "address", "city", "mobile_no", "email_id")
 VALUES (556677, 'Pankaj', 'Talwade', 'Pune', 8796, 'a@a.com');
 
 insert into customer ("customer_id", "customer_name", "address", "city", "mobile_no", "email_id")
 VALUES (556678, 'Raj', 'Bandra', 'Mumbai', 86336, 'b@b.com');
...
"loan_status","loan_commencement_date","loan_creation_date","loan_emi_date")
 VALUES (1000, 1, 'HL-123', '30000','HL', 556677, 1,240,9.0,'Open','2016-03-21 09:10:59.897666','2016-04-21 09:10:59.897666','2016-05-21 09:10:59.897666');
 ...
 VALUES (1001, 1, 'AL-153', '20000','AL', 556678, 1,84,9.75,'Open','2016-03-21 09:10:59.897666','2016-04-21 09:10:59.897666','2016-05-21 09:10:59.897666');
 
 insert into loan ("loan_account_id", "branch_id", "loan_account_number", "amount", "loan_type", "customer_id", "loan_id","duration","rate_of_interest",
 "loan_status","loan_commencement_date","loan_creation_date","loan_emi_date")
 VALUES (1002, 1, 'PL-154', '50000','PL', 556677, 1,60,11.49,'Open','2016-03-21 09:10:59.897666','2016-04-21 09:10:59.897666','2016-05-21 09:10:59.897666');
 
 insert into loan ("loan_account_id", "branch_id", "loan_account_number", "amount", "loan_type", "customer_id", "loan_id","duration","rate_of_interest",
 "loan_status","loan_commencement_date","loan_creation_date","loan_emi_date")
 VALUES (1003, 1, 'AL-153', '20000','AL', 556678, 1,84,9.75,'Open','2016-03-21 09:10:59.897666','2016-04-21 09:10:59.897666','2016-05-21 09:10:59.897666');